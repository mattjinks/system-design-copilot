...
function CapacityEstimatesExample({
  show,
  handleClose,
      ...
      <Modal show={show} onHide={handleClose} dialogClassName="custom-modal">
        ...
        <Modal.Body>
          <Form.Label>
            ...
            If on average, a user views five videos per day then the total
            video-views per second would be:
          </Form.Label>
          ...
          <div className="padding-bottom">
            ...
            upload we have 200 videos viewed, giving us 230 videos uploaded per
            second.
          </div>
        </Modal.Body>
        <Modal.Footer>
