...
function StorageEstimatesExample({
  show,
  handleClose,
  ...
  return (
    <>
      <Modal show={show} onHide={handleClose} dialogClassName="custom-modal">
        ...
        <Modal.Body>
          <Form.Label>
            For a video sharing service such as YouTube, let's assume that every
            minute 500 hours worth of videos are uploaded to Youtube. If on
            average, one minute of video needs 50MB of storage (videos need to
            be stored in multiple formats), the total storage needed for videos
